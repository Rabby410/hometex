                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('admin/products/'.$product->id.'/delete') }}" onclick="return confirm('Are you sure you want to delete the product data?')" class="btn btn-sm btn-danger">Delete</a>
                                </td>
                            </tr>
